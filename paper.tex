...
\newcommand{\subfigbig}[0]{0.4\textwidth}
\newcommand{\subfigsm}[0]{0.29\textwidth}
\newcommand{\subfigmed}[0]{0.43\textwidth}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.13\textwidth}
    \centering
    \includegraphics[width=\textwidth]{star37e.JPG}
    \caption{} 
    \label{fig:star37e}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{sphx_glr_plot_models_002.png}
    \caption{}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\figmed]{sphx_glr_plot_lcs_001_2_00x.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\figmed]{sphx_glr_results_002_2_00x.png}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.35\textwidth}
    \centering
    \includegraphics[width=\textwidth]{EchoStar-1_image.jpg}
    \caption{}
    \label{fig:echostar1}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.35\textwidth}
    \centering
    \includegraphics[width=\textwidth]{sphx_glr_plot_models_001.png}
    \caption{}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\figmed]{sphx_glr_plot_lcs_002_2_00x.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\figmed]{sphx_glr_results_004_2_00x.png}
